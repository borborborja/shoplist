...
// @ts-ignore
const bring_api_1 = __importDefault(require("bring-api"));
...
const pb = new pocketbase_1.default(PB_URL);
const bring = new bring_api_1.default({ email: BRING_EMAIL, password: BRING_PASSWORD });
async function main() {
    ...
    try {
        ...
        if (BRING_LIST_UUID) {
            ...
            lists.lists.slice(0, 3).forEach((l) => console.log(`   - ${l.name} (UUID: ${l.uuid})`));
        }
    }
    catch (e) {
